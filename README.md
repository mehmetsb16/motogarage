...
Motogarage, bir garajdaki araç envanterini yönetmek ve bakım geçmişlerini izlemek için geliştirilmiş **Spring Boot** tabanlı bir backend projesidir.
...
2. IntelliJ IDEA üzerinde projenizi açın.
3. `MotogarageApplication` sınıfını çalıştırın.
4. Postman kullanarak `http://localhost:8080` üzerinden isteklerinizi yönetin.
